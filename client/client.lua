...
--<!>-- NOTIFICATIONS START --<!>--
RegisterNetEvent('DevX-consumables:notifications')
AddEventHandler('DevX-consumables:notifications', function(msg, type)
...
--<!>-- EAT FOOD START --<!>--
RegisterNetEvent('DevX-consumables:client:EatFood', function(args, itemName)
...
RegisterNetEvent('DevX-consumables:client:EatRiskyFood', function(args, itemName)
    local player = PlayerPedId()
    name = '' -- Progress bar name
    lang = '' -- Progress bar text
    timer = '' -- Progress bar timer
...
--<!>-- DRINKS START --<!>--
RegisterNetEvent('DevX-consumables:client:Drink', function(args, itemName)
    local player = PlayerPedId()
    name = '' -- Progress bar name
    lang = '' -- Progress bar text
    timer = '' -- Progress bar timer
...
--<!>-- RISKY DRINKS START --<!>--
RegisterNetEvent('DevX-consumables:client:RiskyDrink', function(args, itemName)
    local player = PlayerPedId()
    name = '' -- Progress bar name
    lang = '' -- Progress bar text
    timer = '' -- Progress bar timer
...
--<!>-- ALCOHOL START --<!>--
RegisterNetEvent('DevX-consumables:client:Alcohol', function(args, itemName)
    local player = PlayerPedId()
    name = '' -- Progress bar name
    lang = '' -- Progress bar text
    timer = '' -- Progress bar timer
...
--<!>-- OPEN 6 PACK START --<!>--
RegisterNetEvent('DevX-consumables:client:Open6Pack', function(args)
    ...
    TriggerEvent('DevX-consumables:notifications', lang, 'success')
end)
...
function FeelSick()
    local player = PlayerPedId()
    Wait(2000) -- 2 seconds
    TriggerEvent('DevX-consumables:notifications', 'You feel sick..', 'primary')
    Wait(5000) -- 5 seconds
    ...
    ClearPedTasks(player)
		...
		TriggerEvent('DevX-consumables:notifications', 'Action Cancelled!', 'error')
	end) 
end
--<!>-- FEEL SICK END --<!>--
